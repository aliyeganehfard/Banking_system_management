...
public class BankEmployeeRepository {
    ...
    public Integer insert(BankEmployee bankEmployee) {
        Integer id = null;
        try {
            query = "insert into BSM_bank_employee (bank_branch_id, employee_name, employee_national_code) " +
                    "VALUES (?,?,?);";
    ...
    public List<BankEmployee> findAll(BankEmployee bankEmployee) {
        List<BankEmployee> bankEmployees = null;
        try {
            query = "select * " +
                    "from BSM_bank_employee " +
